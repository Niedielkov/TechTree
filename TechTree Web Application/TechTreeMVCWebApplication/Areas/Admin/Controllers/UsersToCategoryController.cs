...
namespace TechTreeMVCWebApplication.Areas.Admin.Controllers
{
    ...
    public class UsersToCategoryController : Controller
    {
        ...
        {
            var usersForCategoryToAdd = (from useCat in usersCategoryListModel.UsersSelected
        ...
        {
            var usersForCategoryToDelete = (from useCat in _context.UserCategory
                                         where useCat.CategoryId == categoryId
                                         select new UserCategory
                                         {
                                             Id = useCat.Id,
                                             CategoryId = categoryId,
                                             UserId = useCat.UserId
                                         }).ToList();
