...
namespace TechTreeMVCWebApplication.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (_signInManager.IsSignedIn(User))
            {
                ...
                if(user != null)
                {
                    ...
                    groupedCategoryItemsByCategoryModels = GetGroupedCategoryItemsByCategoryModels(categoryItemDetailsModels);
        ...
        private IEnumerable<GroupedCategoryItemsByCategoryModel> GetGroupedCategoryItemsByCategoryModels(IEnumerable<CategoryItemDetailsModel> categoryItemDetailsModels)
        {
